...
PACKAGES=("libqt6core6" "libqt6gui6" "libqt6qml6" "libqt6quick6" "libqt6multimedia6" "libqt6multimediawidgets6" "libqt6multimediaquick6" "libgl1-mesa-glx" "libegl1-mesa" "fonts-droid-fallback" "qml6-module-qtquick" "qml6-module-qtquick-controls" "qml6-module-qtquick-templates" "qml6-module-qtquick-window" "qml6-module-qtquick-layouts" "qml6-module-qtqml-workerscript" "qml6-module-qtmultimedia" "gstreamer1.0-tools" "gstreamer1.0-plugins-base" "gstreamer1.0-plugins-good" "gstreamer1.0-plugins-bad" "gstreamer1.0-libav" "gstreamer1.0-libcamera" "libcamera-apps" "qt6-multimedia-dev")
MISSING_PACKAGES=()
