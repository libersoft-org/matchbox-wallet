...
Rectangle {
	...
	property string title: tr("wallet.addressbook.title")
			...
			ScrollView {
				...
				ListView {
					...
					Text {
						...
						text: isLoading ? tr("common.loading") : (addressBookItems.length === 0 ? tr("wallet.addressbook.empty") : "")
						color: colors.secondaryText
						font.pixelSize: 16
	...
	Dialog {
		...
		ColumnLayout {
			...
			Text {
				text: tr("wallet.addressbook.add.name")
				color: colors.primaryText
			}
			...
			Text {
				text: tr("wallet.addressbook.add.address")
				color: colors.primaryText
			}
	...
	Dialog {
		...
		ColumnLayout {
			...
			Text {
				text: tr("wallet.addressbook.edit.name")
				color: colors.primaryText
			}
			...
			Text {
				text: tr("wallet.addressbook.edit.address")
				color: colors.primaryText
			}
	...
	Dialog {
		...
		ColumnLayout {
			...
			Text {
				text: tr("wallet.addressbook.delete.confirm") + " \"" + deleteItemName + "\"?"
				color: colors.primaryText
				wrapMode: Text.Wrap
				Layout.fillWidth: true
			}
