...
const HANDLERS = {
	...
	systemSyncTime: () => systemManager.syncSystemTime(),
	systemSetAutoTimeSync: (params) => systemManager.setAutoTimeSync(params),
	systemGetVolume: () => systemManager.getSystemVolume(),
	systemSetVolume: (params) => systemManager.setSystemVolume(params),
	systemGetBrightness: () => systemManager.getSystemBrightness(),
	systemSetBrightness: (params) => systemManager.setSystemBrightness(params),
